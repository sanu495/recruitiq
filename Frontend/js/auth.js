...
function buildSidebar(activeItem = '') {
  ...
  const recruiterNav = [
    { id: 'dashboard',  icon: iconDashboard(), label: 'Dashboard',     href: '/dashboard/recruiter' },
    { id: 'jobs',       icon: iconBriefcase(), label: 'My Jobs',       href: '/jobs' },
    { id: 'pipeline',   icon: iconPipeline(),  label: 'Pipeline',      href: '/pipeline' },
    { id: 'interviews', icon: iconCalendar(),  label: 'Interviews',    href: '/interviews' },
    { id: 'analytics',  icon: iconChart(),     label: 'Analytics',     href: '/analytics' },
  ];

  const candidateNav = [
    { id: 'dashboard',    icon: iconDashboard(), label: 'Dashboard',       href: '/dashboard/candidate' },
    { id: 'jobs',         icon: iconBriefcase(), label: 'Browse Jobs',     href: '/jobs' },
    { id: 'applications', icon: iconApps(),      label: 'My Applications', href: '/applications' },
    { id: 'interviews',   icon: iconCalendar(),  label: 'Interviews',      href: '/interviews' },
  ];
...
function buildTopbar(title, subtitle = '') {
  ...
  topbar.innerHTML = `
    ...
    <div class="topbar-right">
      ...
      <div class="notif-btn" id="notif-btn" onclick="window.location.href='/notifications'">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
